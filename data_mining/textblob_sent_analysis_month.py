#python textblob_sent_analysis_month.py in_csv word neighborhood [dist]
...
plt.xlabel("Months")
plt.ylabel("Polarity")
plt.bar(np.arange(len(mean_month_polarity)), mean_month_polarity, 0.7)
plt.xticks(np.arange(0, len(mean_month_polarity), 12), np.arange(1970, 1970 + len(mean_month_polarity)))
plt.show()