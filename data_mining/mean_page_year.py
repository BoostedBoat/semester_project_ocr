#python mean_page_year.py in_folder word [distance]
...
plt.title("Mean page where " + word + " appears.")
plt.xlabel("Years")
plt.ylabel("Mean")
plt.bar(np.arange(len(mean)), mean, 0.7)
plt.xticks(np.arange(0, len(mean)), np.arange(1970, 1970 + len(mean)))
plt.show()